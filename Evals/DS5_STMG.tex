...
\item L'inverse de $\dfrac87$ est $\dots$
\item $\lim\limits_{\substack{x \to 0 \\ x <0 }} \dfrac1{x} = \dots$
\item $\lim\limits_{x \to - \infty} \dfrac1{x} = \dots$
\item $\lim\limits_{x \to + \infty} 3x - 2 - \dfrac5{x} = \dots$
\item $\lim\limits_{\substack{x \to 0 \\ x > 0 }} 3x - 2 - \dfrac5{x} = \dots$
\end{enumerate}
\textit{Note : attention au signe devant la fonction inverse !}
}{exe:1a}{
\begin{enumerate}[itemsep=6pt]
\item L'inverse de $\dfrac87$ est $\dfrac78$
\item $\lim\limits_{\substack{x \to 0 \\ x <0 }} \dfrac1{x} = -\infty$
\item $\lim\limits_{x \to - \infty} \dfrac1{x} = 0$
\item $\lim\limits_{x \to + \infty} 3x - 2 - \dfrac5{x} = +\infty$
\item $\lim\limits_{\substack{x \to 0 \\ x > 0 }} 3x - 2 - \dfrac5{x} = -\infty$
\end{enumerate}
}
